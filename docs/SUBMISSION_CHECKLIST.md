...
| At least one AWS service meaningfully integrated | Bedrock reasoning/embedding, ECS, S3, CloudWatch, WAF in code and IaC | Ready in code; live URL pending |
...
| Functional demo URL free for judges through judging | Secure AWS runbook exists | **Pending external deployment** |
...
| Testing access/instructions | `docs/JUDGE_GUIDE.md`; production OIDC requires judge credentials | Local ready; hosted credentials pending |
