...
| Bedrock outage, throttling, or malformed response | Bounded standard retries then deterministic evidence-only fallback marked degraded | Lower semantic quality during outage; structured degradation event is emitted |
